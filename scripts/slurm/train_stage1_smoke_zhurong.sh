...
#SBATCH --job-name=qvlseg-stage1-smoke-zr
#SBATCH --output=/mingli01/project/xiyongkai/qwen3vl-seg/logs/stage1-smoke-zr-%j.out
#SBATCH --error=/mingli01/project/xiyongkai/qwen3vl-seg/logs/stage1-smoke-zr-%j.err
