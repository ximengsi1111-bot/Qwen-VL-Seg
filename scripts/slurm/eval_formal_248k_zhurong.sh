...
#SBATCH --job-name=qvlseg-eval-formal-248k
#SBATCH --output=/mingli01/project/xiyongkai/qwen3vl-seg/logs/eval-formal-248k-%j.out
#SBATCH --error=/mingli01/project/xiyongkai/qwen3vl-seg/logs/eval-formal-248k-%j.err
set -e
...
python3 -m qwen3vl_seg.eval.runner \
  ...
  --max-pixels 262144 \
  --max-samples 0 \
  --output-dir /mingli01/data/xyk/runs/eval/stage2-248k-formal