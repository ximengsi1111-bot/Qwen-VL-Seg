...
#SBATCH --job-name=qvlseg-stage2-100k-bucket
#SBATCH --output=/mingli01/project/xiyongkai/qwen3vl-seg/logs/stage2-100k-bucket-%j.out
#SBATCH --error=/mingli01/project/xiyongkai/qwen3vl-seg/logs/stage2-100k-bucket-%j.err
...
deepspeed \
  ...
  --config configs/train/stage2_100k_bucket_micro4_zhurong.yaml \
  --deepspeed-config configs/train/deepspeed_stage2_100k_bucket_zhurong.json
