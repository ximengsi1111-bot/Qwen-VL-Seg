...
#SBATCH --job-name=qvlseg-grpo-eval-500
#SBATCH --output=/mingli01/data/xyk/grpo/eval_ckpt500.out
#SBATCH --error=/mingli01/data/xyk/grpo/eval_ckpt500.err
set -e
...
export GRPO_ADAPTER=/mingli01/data/xyk/grpo/train_out/v0-20260908-124037/checkpoint-500
