...
#SBATCH --job-name=qvlseg-stage1-248k
#SBATCH --output=/mingli01/project/xiyongkai/qwen3vl-seg/logs/stage1-248k-%j.out
#SBATCH --error=/mingli01/project/xiyongkai/qwen3vl-seg/logs/stage1-248k-%j.err
set -e
...
export HF_HOME=/file_storage01/home/mingli/data/xyk/cache/hf
export PYTHONPATH=.
export PYTORCH_CUDA_ALLOC_CONF=max_split_size_mb:1024
mkdir -p logs
MASTER_PORT=$((29000 + SLURM_JOB_ID % 1000))
deepspeed --num_nodes=1 --num_gpus=4 --master_port=$MASTER_PORT \
  --module qwen3vl_seg.train.training_loop \
  --config configs/train/stage1_248k_zhurong.yaml \
