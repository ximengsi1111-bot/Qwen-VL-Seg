...
#SBATCH --job-name=qvlseg-maskiou-test
#SBATCH --output=/mingli01/data/xyk/grpo/maskiou_test.out
#SBATCH --error=/mingli01/data/xyk/grpo/maskiou_test.err
set -e
...
python scripts/eval/test_mask_iou.py