...
#SBATCH --job-name=qvlseg-stage2-248k
#SBATCH --output=/mingli01/project/xiyongkai/qwen3vl-seg/logs/stage2-248k-%j.out
#SBATCH --error=/mingli01/project/xiyongkai/qwen3vl-seg/logs/stage2-248k-%j.err
set -e
...
deepspeed --num_nodes=1 --num_gpus=4 --master_port=$MASTER_PORT \
  ...
  --config configs/train/stage2_248k_zhurong.yaml \
