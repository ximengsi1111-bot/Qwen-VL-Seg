...
#SBATCH --job-name=qvlseg-stage1
#SBATCH --output=/mingli01/project/xiyongkai/qwen3vl-seg/logs/stage1-%j.out
#SBATCH --error=/mingli01/project/xiyongkai/qwen3vl-seg/logs/stage1-%j.err
...
deepspeed \
  ...
  --deepspeed-config configs/train/deepspeed_stage1_4gpu.json
