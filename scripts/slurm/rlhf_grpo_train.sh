...
#SBATCH --job-name=qvlseg-grpo-train
#SBATCH --output=/mingli01/data/xyk/grpo/train.out
#SBATCH --error=/mingli01/data/xyk/grpo/train.err
...
python qwen3vl_seg/grpo/run_rlhf.py \
  ...
  --model_type qwen3_vl \
  --dataset /mingli01/data/xyk/grpo/rl_dataset.jsonl \
  ...
  --max_steps 1000 \
  --report_to none \
  --output_dir /mingli01/data/xyk/grpo/train_out