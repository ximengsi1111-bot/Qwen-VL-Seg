...
#SBATCH --job-name=qvlseg-stage1-100k-bucket
#SBATCH --output=/mingli01/project/xiyongkai/qwen3vl-seg/logs/stage1-100k-bucket-%j.out
#SBATCH --error=/mingli01/project/xiyongkai/qwen3vl-seg/logs/stage1-100k-bucket-%j.err
...
deepspeed \
  ...
  --config configs/train/stage1_100k_bucket_micro4_zhurong.yaml \
  --deepspeed-config configs/train/deepspeed_stage1_100k_bucket_zhurong.json
