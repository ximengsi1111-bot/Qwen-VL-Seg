...
#SBATCH --job-name=qvlseg-stage2-100k-maskfix
#SBATCH --output=/mingli01/project/xiyongkai/qwen3vl-seg/logs/stage2-100k-maskfix-%j.out
#SBATCH --error=/mingli01/project/xiyongkai/qwen3vl-seg/logs/stage2-100k-maskfix-%j.err
...
deepspeed \
  ...
  --config configs/train/stage2_100k_maskfix_zhurong.yaml \
